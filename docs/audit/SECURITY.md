...
>
> One item there no commit can close — **SEC-2b** (renderer DNS rebinding, which needs
> container-level egress restriction) — is why this report must not be read as fully
> remediated.
